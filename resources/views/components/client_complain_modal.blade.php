 <div class="text-end">
     <span class="mt-2 d-block mt-5 " style="cursor: pointer;border: 1px solid;display: inline-block !important;background-color: #fea84b;border-radius: 5px;padding: 10px;font-size: 14px;font-weight: bold;"
...
<div class="modal fade" id="complain-modal" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
            <form action="{{ route('client.complain.store',$order) }}" method="post" class="modal-content w-color" style="background-color: #131416">
                <div class="smartwizard">
                    ...
                    <div class="tab-content">
                        <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                            {!! \App\Models\Settings::valueByKey('complain_terms_and_conditions') !!}
                        </div>
